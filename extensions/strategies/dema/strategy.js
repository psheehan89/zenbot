...
module.exports = function container (get, set, clear) {
  return {
    ...
    getOptions: function () {
      ...
      this.option('period_length', 'period length', String, '2m')
    ...
    onReport: function (s) {
      ...
      if (typeof s.period.dema_histogram === 'number') {
        ...
        cols.push(z(8, n(s.period.ema_short).format('00.00'), ' ').magenta)
        cols.push(z(8, n(s.period.ema_long).format('00.00'), ' ').blue)
        cols.push(z(9, n(s.period.dema_histogram).format('+00.0000'), ' ')[color])
